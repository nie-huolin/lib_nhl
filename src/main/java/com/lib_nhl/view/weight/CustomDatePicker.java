package com.lib_nhl.view.weight;
...
public class CustomDatePicker {
    ...
    private String startDate, endDate, courrTime;
    ...
    public CustomDatePicker(Context context, String startDate, String endDate, String title, String titleColor,
        ...
        if (isValidDate(startDate, "yyyy-MM-dd") && isValidDate(endDate, "yyyy-MM-dd")) {
            ...
            showSpecificTime(false); // 显示时和分
            setIsLoop(false); // 允许循环滚动
            show(value);
        }
    }
...
//            datePickerDialog.setCancelable(true);
    ...
    private void initView() {
        ...
        if (!TextUtils.isEmpty(cancelTitle)) {
            ...
            tv_cancle.setText(R.string.cancel);
        }
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd", Locale.CHINA);
                if (sdf.format(selectedCalender.getTime()).compareTo(endDate) <= 0) {
                    listener.onPick(true, sdf.format(selectedCalender.getTime()));
                } else {
                    Toast.makeText(context, "选择时间不能比当前时间大", Toast.LENGTH_SHORT).show();
                    return;
